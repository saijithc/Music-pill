    ...
    Row(mainAxisAlignment: MainAxisAlignment.start,
      children: [
        Padding(
          ...
          child: InkWell( child: const Text('Contact',style: TextStyle(color: Colors.amber,fontSize: 20,fontWeight: FontWeight.w600),),onTap: (){
            showDialog(
              context: context,
              builder:(context){
                return  AlertDialog(
                 actions: [Column(children:  [ListTile(title: const Text('LinkedIn',),onTap: (){
                   launchUrl(Uri.parse('https://www.linkedin.com/in/saijith-sai-108643236'));

                 },),const Divider(height: 1),ListTile(title:const Text('instagram'),onTap: (){
                    launchUrl(Uri.parse('https://www.instagram.com/_saijithsai/'));
                 },)],)],
                );
              }
              );
